         ...
         <div class="lw-forma-wrapper">
            <form id="LwRegistrationForm" class="lw-form" method="post">
               ...
               <div class="lw-form-group">
                  ...
                  <input type="text" value="<?php echo isset($prePouplateData['last_name'])?stripcslashes($prePouplateData['last_name']):""; ?>"  placeholder="Your Last Name"    class="required lettersonly" name="lw_last_name" id="lw_last_name">
               </div>
               <div class="lw-form-group">
               ...
               <div class="lw-form-group">
...
</span></div></label>  <input readonly type="email" placeholder="Your Email Address" class="email validateEmail validateEmailEdu required"  value="<?php echo isset($prePouplateData['email'])?stripcslashes($prePouplateData['email']):""; ?>" id="lw_email_address" name="lw_registration_email">
                  </div>
                ...
                <div class="lw-form-group">
                   ...
                   <input type="text" placeholder="Livewire Username" class="required user_3_consecutive username_valid"  name="lw_username" id="lw_username">
